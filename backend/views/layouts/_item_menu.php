...
return[
    ...
    ['label' => 'category', 'icon' => 'database text-green','url' => ['/category'],
        'visible' => !Yii::$app->user->isGuest 
    ], 
    ['label' => 'post', 'icon' =>'database text-green', 'url' => ['/post'],
    'visible' => !Yii::$app->user->isGuest 
    ], 
    ['label' => 'upload-file', 'icon' =>'file text-blue', 'url' => ['/uploaded-file'],
    'visible' => !Yii::$app->user->isGuest 
    ], 
